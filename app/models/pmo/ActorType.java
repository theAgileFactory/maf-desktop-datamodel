...
/**
 * The type of actor.<br/>
 * Can be used to specify different characteristics.<br/>
 * For instance: internal, external, temporary, etc.
 * 
...
public class ActorType extends Model implements IModel, IApiObject, ISelectableValueHolder<Long> {
    ...
    /**
     * Returns the list of Actors which are of the current type.
     */
    @OneToMany(mappedBy = "actorType")
    public List<Actor> sameTypeActors;

    @Override
    public String audit() {
        return "ActorType [id=" + id + ", name=" + name + "]";
    }
