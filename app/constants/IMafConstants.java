...
public interface IMafConstants extends IFrameworkConstants {
    ...
    public static final String ADMIN_ATTACHMENTS_MANAGEMENT_PERMISSION_NO_CONFIDENTIAL = "ADMIN_ATTACHMENTS_MANAGEMENT_PERMISSION_NO_CONFIDENTIAL";
    ...
    public static final String PORTFOLIO_ENTRY_EDIT_AS_PORTFOLIO_STAKEHOLDER_PERMISSION = "PORTFOLIO_ENTRY_EDIT_AS_PORTFOLIO_STAKEHOLDER_PERMISSION";
    ...
    public static final String RELEASE_SUBMISSION_PERMISSION = "RELEASE_SUBMISSION_PERMISSION";
    ...
    public static final String PORTFOLIO_ENTRY_EDIT_FINANCIAL_INFO_AS_PORTFOLIO_STAKEHOLDER_PERMISSION = "PORTFOLIO_ENTRY_EDIT_FINANCIAL_INFO_AS_PORTFOLIO_STAKEHOLDER_PERMISSION";
    ...
    public static final String BUDGET_TRACKING_EFFORT_BASED_PREFERENCE = "BUDGET_TRACKING_EFFORT_BASED_PREFERENCE";
    public static final String READONLY_GOVERNANCE_ID_PREFERENCE = "READONLY_GOVERNANCE_ID_PREFERENCE";
}
