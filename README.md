# Desktop data model [![Build Status](https://travis-ci.org/AblionGE/maf-desktop-datamodel.svg?branch=master)](https://travis-ci.org/AblionGE/maf-desktop-datamodel)
