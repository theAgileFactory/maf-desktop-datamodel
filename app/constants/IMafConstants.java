...
public interface IMafConstants extends IFrameworkConstants {
    ...
    public static final String ROADMAP_FILTER_STORAGE_PREFERENCE = "ROADMAP_FILTER_STORAGE_PREFERENCE";
    public static final String REQUIREMENTS_FILTER_STORAGE_PREFERENCE = "REQUIREMENTS_FILTER_STORAGE_PREFERENCE";
    public static final String PACKAGES_FILTER_STORAGE_PREFERENCE = "PACKAGES_FILTER_STORAGE_PREFERENCE";
    public static final String EVENTS_FILTER_STORAGE_PREFERENCE = "EVENTS_FILTER_STORAGE_PREFERENCE";
    public static final String ITERATIONS_FILTER_STORAGE_PREFERENCE = "ITERATIONS_FILTER_STORAGE_PREFERENCE";
    public static final String RELEASES_FILTER_STORAGE_PREFERENCE = "RELEASES_FILTER_STORAGE_PREFERENCE";
