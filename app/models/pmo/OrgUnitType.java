...
/**
 * A type of Organizational unit (see {@link OrgUnit}).
 * 
...
public class OrgUnitType extends Model implements IModel, IApiObject, ISelectableValueHolder<Long> {
    ...
    /**
     * The list of orgUnits with the same type.
     */
    @OneToMany(mappedBy = "orgUnitType")
    public List<OrgUnit> sameTypeOrgUnits;

    @Override
    public String audit() {
        return "OrgUnitType [id=" + id + ", name=" + name + "]";
    }
